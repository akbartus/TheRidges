...
function startTour() {
	...
	document.getElementById("kennedyFirst2").addEventListener("click", function () {
		...
		document.getElementById('description').innerHTML = "Pictured in the hallway to the first-floor galleries is the description of the Pattern and Disruption: <i>Diné Lifeways and Embedded Mathematics</i> exhibit";
		document.getElementById('kennedyExterior').setAttribute('style', "background: none;");
		document.getElementById('kennedyFirstEntrance').setAttribute('style', "background: none;");
		document.getElementById('kennedyFirst1').setAttribute('style', "background: none;");
	...
	document.getElementById("kennedyFirst3").addEventListener("click", function () {
		...
		document.getElementById('description').innerHTML = "Pictured is the Pattern and Disruption: <i>Diné Lifeways and Embedded Mathematics</i> exhibit";
		document.getElementById('kennedyExterior').setAttribute('style', "background: none;");
		document.getElementById('kennedyFirstEntrance').setAttribute('style', "background: none;");
		document.getElementById('kennedyFirst1').setAttribute('style', "background: none;");
		document.getElementById('kennedyFirst2').setAttribute('style', "background: none;");
	...
	document.getElementById("building13Tooltip").addEventListener("click", function () {
		...
		document.getElementById('building13E3').setAttribute('style', "background: none;");
	...
	document.getElementById("building13E2").addEventListener("click", function () {
		...
		document.getElementById('description').innerHTML = "Pictured is the corridor of the Ohio University Police Department that houses its administrative offices";
		document.getElementById('building13Exterior').setAttribute('style', "background: none;");
		document.getElementById('building13E1').setAttribute('style', "background: none;");
	...
	document.getElementById("building13E3").addEventListener("click", function () {
		...
		document.getElementById('description').innerHTML = "Pictured is the corridor of the Ohio University Police Department that houses its operations offices";
		document.getElementById('building13Exterior').setAttribute('style', "background: none;");
		document.getElementById('building13E1').setAttribute('style', "background: none;");
		document.getElementById('building13E2').setAttribute('style', "background: none;");
		document.getElementById('building13E3').setAttribute('style', "background: rgb(199 116 92 / 0.9);");
		document.getElementById('building13E4').setAttribute('style', "background: none;");
	});
